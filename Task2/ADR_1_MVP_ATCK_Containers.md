...
Критичным местом такой архитектуры будет Шлюз событий. При его сбое или отказе, сервер не будет получать никаких данных с фермы.
...
Недостатки альтернативного решения:
 ...
 - Сложность расширения - при внедрении нового функционала нужно будет перестраивать потоки сообщений между различными частями системы, либо полностью их пересматривать