...
Значительное вляние на архитектуру сети могут дать такие ограничения как +R6 - нестабильный Wi-Fi, при этом применяются серьезные требования к времени реакции видеонаблюдения (P3, P4). 
...
В случае если система позиционирует себя в будующем как SaaS решение, необходимо рассмотреть возможность интеграции системы с другими модулями:
- метрики могут передаваться в OpenTelemetry. Это один из общепринятых стандартов метрик
- вместо синхронизации с ERP системой 1С:Агро, нужно рассмотреть возможность интеграции с другими системами, либо предоставить API - сервис
- заявки на обслуживание умных систем так же могут быть интегрированы с различными системами
- данные о состоянии животных могут быть интегрированы в сторонний Vet модель или Erp - систему.
- даже управление метриками может осуществлять не непосредственно аналитиком, а в интеграции с аналитическими системами сторонних предприятий

Для простоты реализации MVP, оставим API сервис для интеграции со все возможными сторонними сервисами.
...
Альтернативный вариант подходит для предоставления системы АТСК как полноценного SaaS решения

Недостатки:
- отказ от использования уже существующих систем компании
