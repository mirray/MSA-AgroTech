...
- взамен синхронизации с ERP системой АгроТех Х, нужно рассмотреть возможность интеграции с другими ERP-системами
- заявки на обслуживание умных систем могут быть интегрированы с системами работы с заявками (Jira)
- данные о состоянии животных могут быть синхронизированы системами ветеринарного учета (Хорриот).
- управление метриками может осуществлять не непосредственно аналитиком, а в интеграции с различными аналитическими системами

Для простоты реализации MVP, оставим API сервис для интеграции со сторонними сервисами.
