...
Возможно минимизировать издержки, передав часть нерегулярных задач на аутсорс: 
 - установка и сопровождение камер видеонаблюдения может выполняться сторонним специалистом, так же как установка, настройка и ремонт автоматических кормушек и поилок может осуществляться вендором автоматизированных устройств.
